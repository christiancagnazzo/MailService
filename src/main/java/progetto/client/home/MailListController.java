...
import progetto.common.mail.Email;
import javafx.fxml.FXML;
import javafx.scene.control.ListView;
import progetto.client.write.WriteController;
import progetto.client.write.WriteModel;
...
public class MailListController {
    ...
    private void writeNewMail(ActionEvent event) throws IOException {
        ...
        FXMLLoader newWriteLoader = new FXMLLoader(getClass().getClassLoader().getResource("writeEmail.fxml"));
